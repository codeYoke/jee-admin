package com.fjh.backup.controller;
...
import com.fjh.backup.constants.BackupConstants;
import com.fjh.backup.datasource.BackupDataSourceProperties;
import com.fjh.backup.service.MysqlBackupService;
import com.fjh.backup.utils.HttpResult;
...
public class MySqlBackupController {
	...
	public HttpResult findBackupRecords() {
		...
		List<Map<String, String>> backupRecords = new ArrayList<>();//用来存放备份记录
